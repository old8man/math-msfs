...
AFN-T formalizes the structural fact that mathematics admits no single absolute foundation: each foundation is locally complete at $\LFnd$; the space of foundations is classifiable at $\LCls$; $\LAbs$ is empty. Foundational plurality is not a deficiency awaiting unification but a structural feature formally necessary by Theorem~\ref{thm:afnt}.
