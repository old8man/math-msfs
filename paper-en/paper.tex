...
AFN-T imposes a uniform structural bound on every current foundational programme: each is confined to one of the formal levels $\LFnd$, $\LCls$, or $\LClsMax$, with $\LAbs$ empty. Specifically:
