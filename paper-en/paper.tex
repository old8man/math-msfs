...
Russell~\cite{Russell1903} & $\ZFC$ & putative-set witness of $\{x : x \notin x\}$ & $1$ & $\phi_R(x) \equiv x \notin x$ \\
G\"odel I~\cite{Godel1931} & $\mathsf{PA}$ & $G$ (unprovable sentence) & $1$ & $\phi_G \equiv \neg \mathrm{Prov}(\ulcorner G \urcorner)$ \\
G\"odel II~\cite{Godel1931} & $\mathsf{PA}$ & putative $\mathsf{PA}$-internal proof of $\mathrm{Con}(\mathsf{PA})$ & $1$ & $\phi_{\mathrm{Con}}$ via $\mathrm{Prov}$-predicate \\
Tarski~\cite{Tarski1936} & $\mathsf{PA}$ & putative arithmetical truth predicate $T \subseteq \mathsf{Formulas}$ & $1$ & $T(\phi) \equiv \phi$ for each $\phi$ \\
